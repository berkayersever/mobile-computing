...
public class ReminderAdapter extends RecyclerView.Adapter<ReminderAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder myViewHolder, int i) {
        ...
        myViewHolder.nameView.setText(reminder.getTitle());
        ...
        myViewHolder.activeSwitch.setChecked(reminder.getStatus());
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        MyViewHolder(View rowView) {
            ...
            priorityBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
                ...
                @Override
                public void onStopTrackingTouch(SeekBar seekBar) { eventHandler.onPriorityBarChange(getAdapterPosition(), seekBar.getProgress()); }
            });
        }
    }
