...
public class DetailsViewModel extends ViewModel {
    ...
    public final static String PRIORITY_KEY = "com.example.persistent_storage.bundle.priority";
    public final static String TIME_KEY = "com.example.persistent_storage.bundle.time";
    public final static String NAME_KEY = "com.example.persistent_storage.bundle.name";
    public final static String NOTE_KEY = "com.example.persistent_storage.bundle.note";
